...
class AdminGoatTypeController extends Controller
{
    /**
    ...
    {
        $goatTypes = GoatType::latest()->paginate(10);
        
        return Inertia::render('admin/goat-types/index', [
            'goatTypes' => $goatTypes
        ]);
    }
    ...
    {
        return Inertia::render('admin/goat-types/show', [
            'goatType' => $goatType
        ]);
    }
